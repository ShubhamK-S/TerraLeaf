...
const DetailsPage = (props) => {
    ...
    const submitReview = async (e) => {
        ...
        try {
            ...
            await axios.post("http://localhost:3006/productReviews", reviewFields).then((response) => {
    ...
    const showReviews = async () => {
        try {
            await axios.get("http://localhost:3006/productReviews").then((response) => {
                        ...
                        <div className='col-md-7 productInfo'>
...

                            {
                                ...
                                <div className='productSize d-flex align-items-center'>
                                    <span>Dimenstions</span>
                                    <ul className='list list-inline mb-0 pl-4'>
                                        {
                                            currentProduct.weight.map((item, index) => {
                                                return (
                                                    <li className='list-inline-item'><a className={`tag ${activeSize === index ? 'active' : ''}`} onClick={() => isActive(index)}>{item}cm</a></li>
                                                )
                                            })
                                        }
                                    </ul>
